...
class Envio(models.Model):
    ...
    def archivar(self):
        """Marca el envío como archivado"""
        from django.utils import timezone
        self.archivado = True
        self.fecha_archivo = timezone.now()
        self.save(update_fields=["archivado", "fecha_archivo", "fecha_actualizacion"])

    def restaurar(self):
        """Restaura el envío desde archivo"""
        self.archivado = False
        self.fecha_archivo = None
        self.save(update_fields=["archivado", "fecha_archivo", "fecha_actualizacion"])
